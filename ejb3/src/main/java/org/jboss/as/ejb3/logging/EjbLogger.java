...
//    NoSuchObjectLocalException timerNotFound(String timerId);
    ...
    @Message(id = 487, value = "Cannot invoke EJB method, as its parent transaction has already rolledback")
    EJBTransactionRolledbackException callerTransactionAlreadyRolledBack();
}